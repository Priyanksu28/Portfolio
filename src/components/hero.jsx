  ...
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      ...
      <div className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
        ...
        <div className="relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#e99b63] shadow-[0_0_15px_rgba(255, 255, 255, 0.4 rounded-full">
          <div className="absolute inset-[3px] bg-black rounded-full flex items-center justify-center gap-2">
            <i
              className="bx bx-current-location text-2xl text-gray-200"
              aria-hidden="true"
            ></i>
            <span>ASSAM</span>
          </div>
        ...
        <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">
          ...
          vero suscipit voluptatum vel repudiandae tenetur hic eligendi.
        </p>
        ...
        <div className="flex gap-4 mt-10">
          ...
          >
            DOWNLOAD CV<i className="bx bx-link-external"></i>
          </button>
        </div>
      </div>
     ...
     data-aos-offset="0" data-aos-duration="3000"
        ...
        scene="https://prod.spline.design/L7XGj4CnHEPuvopA/scene.splinecode"
      />
    </main>
  );
};
